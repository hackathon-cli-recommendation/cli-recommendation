...
| recommendations_source_list | The data source of recommendation items                | list (item value: 1:knowledge base 2:caculation 3:Aladdin 4:search 5:chatgpt)                                                         |
| recommendations_type_list   | The type of recommendation items                       | list (item value: 2:solution 3:command 4:scenario 5:search 6:chatgpt)                                                                 |
| accepted_recommend_source   | The data source of adoption accepted recommendation    | 1:knowledge base 2:caculation 3:Aladdin 4:search 5:chatgpt                                                                            |
| accepted_recommend_type     | The type of accepted recommendation                    | 1:all 2:solution 3:command 4:scenario 5:search 6:chatgpt                                                                              |
